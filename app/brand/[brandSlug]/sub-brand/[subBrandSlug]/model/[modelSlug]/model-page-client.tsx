...
export default function ModelPageClient({ model }: ModelPageClientProps) {
	...
	return (
		<>
			<h1 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6 text-center px-4">
				{model.name}
			</h1>

			{model.description && (
				<p className="text-gray-600 mb-4 sm:mb-6 text-center text-sm sm:text-base px-4">
					{model.description}
				</p>
			)}
				...
				<div className="bg-white border-2 border-green-200 rounded-lg p-4 sm:p-6 shadow-sm min-w-[280px] sm:min-w-[320px]">
					<div className="text-center">
						...
						<p className="text-2xl sm:text-3xl font-bold text-green-700">
							{model.dealerPricing
								? `₹${model.dealerPricing.toLocaleString("en-IN")}`
								: "N/A"}
						</p>
					</div>
				</div>
					...
					<div className="text-center">
						...
						<p className="text-2xl sm:text-3xl font-bold text-blue-700">
							{model.distributorPricing
								? `₹${model.distributorPricing.toLocaleString("en-IN")}`
								: "N/A"}
						</p>
					</div>
				</div>
